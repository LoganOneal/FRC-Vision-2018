...
ap.add_argument("-v", "--video", help="Path to the (optional) video file. Otherwise, will use video0")
...
while True:
    ...
    #origin is the video without the filters
    ...
    # HSV range filter then erode(get rid of small collections of points) and dilate (this basically makes the mask less strict)
